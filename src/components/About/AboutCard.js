      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br /> 😎 I am Full-Stack Developer with a passion for Science and Human Behavior and pursuing Btech in Computer Science Engineering from Lovely Professional University.
